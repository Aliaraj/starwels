Starwels-Qt version 0.8.0 is now available from:
...
Mac and Windows binaries are signed with certificates owned by the Starwels
...
New/changed settings (command-line or starwels.conf file)
--------------------------------------------------------
